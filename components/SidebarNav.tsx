          ...
          <div className="ml-4 flex flex-col gap-0.5">
            {subjects.map(s => (
              <div key={s.id}>
                  ...
                  <div className="pl-2 border-l border-pink-200 ml-4 mt-0.5 mb-0.5 flex flex-col gap-0.5">
                    <Link
                      ...
                      className={`flex items-center gap-1 px-2 py-1 rounded-lg text-xs transition-colors ${
                        pathname.startsWith('/quiz/1')
                          ? 'bg-pink-100 text-pink-800 font-semibold'
                          : 'text-gray-400 hover:bg-gray-50 hover:text-pink-700'
                      }`}
                    >
                ...
                {/* 철도안전법(id=7) 아래 링크들 */}
                {s.id === 7 && (
                  <div className="pl-2 border-l border-red-200 ml-4 mt-0.5 mb-0.5 flex flex-col gap-0.5">
                    <Link
                      href="/kibchul/safety/concept"
                      className={`flex items-center gap-1 px-2 py-1 rounded-lg text-xs transition-colors ${
                        pathname.startsWith('/kibchul/safety/concept')
                          ? 'bg-teal-100 text-teal-800 font-semibold'
                          : 'text-gray-400 hover:bg-gray-50 hover:text-teal-700'
                      }`}
                    >
                      <span className="text-[10px]">└</span>
                      <span>🚂 핵심개념 문제</span>
