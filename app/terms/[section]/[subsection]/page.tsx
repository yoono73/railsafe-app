      ...
      <div className="flex-1 overflow-y-auto p-4">
        <div className="max-w-2xl">
          ...
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="bg-white rounded-xl border border-gray-100 shadow-sm px-4 py-3 mb-2 animate-pulse"
            >
